...
import './home_sceen2.dart';

class HomeSceen1 extends StatelessWidget {
  HomeSceen1({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
                ...
                child: SingleChildScrollView(
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromPins(
                          Pin(start: -56.0, end: 2.0),
                          Pin(start: -97.0, end: 139.0),
                          child:
          ...
          Pinned.fromPins(
            ...
            Pin(size: 56.0, middle: 0.2885),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeOut,
                  duration: 0.4,
                  pageBuilder: () => HomeSceen2(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
